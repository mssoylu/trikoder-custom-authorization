...
final class OAuth2Events
{
     ...
     */
    public const USER_RESOLVE = 'trikoder.custom.authorization.oauth2.user_resolve';
     ...
     */
    public const SCOPE_RESOLVE = 'trikoder.custom.authorization.oauth2.scope_resolve';
     ...
     */
    public const AUTHORIZATION_REQUEST_RESOLVE = 'trikoder.custom.authorization.oauth2.authorization_request_resolve';
}
